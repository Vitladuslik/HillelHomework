public class StudentService {
    ...
    public static void findStudentsByFaculty(String faculty) {
        ...
        for (Student st : StudentRun.students) {
            if (st.getFaculty().equals(faculty)) System.out.println(st);
        }
        System.out.println("----------------------------------------------------");
    ...
    public static void findStudentsByFacultyAndCourse(String faculty, int course) {
        ...
        for (Student st : StudentRun.students) {
            if (st.getFaculty().equals(faculty) && (st.getCourse() == course)) System.out.println(st);
        }
        System.out.println("----------------------------------------------------");
    ...
    public static void findStudentsBornAfter(int year) {
        ...
        for (Student st : StudentRun.students) {
            if (st.getBirthYear() > year) System.out.println(st);
        }
        System.out.println("----------------------------------------------------");
    ...
    public static void findStudentsByGroup(int group) {
        ...
        for (Student st : StudentRun.students) {
            if (st.getGroup() == group) System.out.println(st);
        }
        System.out.println("----------------------------------------------------");
